		...
		switch(view){
			case "tbl_design_stocks":{
				if(val1 == 'approved'){
					...
					let TableData1 = [{data:'id',visible:false},{data:'project_no'},{data:'title',className: "text-nowrap"},{data:'date_created',className: "text-nowrap"},{data:'action',className: "text-nowrap"}]; 
					...
					TableData = [{data:'id',visible:false},{data:'project_no'},{data:'title',className: "text-nowrap"},{data:'date_created',className: "text-nowrap"},{data:'action',className: "text-nowrap"}]; 
					_DataTableLoader('tbl_design_stocks_request',TableURL,TableData,[[ 0, "desc" ]]);
				}else if(val1 == 'rejected'){
					let TableURL2 = baseURL + 'datatable_controller/Design_Stocks_Rejected_DataTable';
					let TableData2 = [{data:'id',visible:false},{data:'project_no'},{data:'title',className: "text-nowrap"},{data:'date_created',className: "text-nowrap"},{data:'action',className: "text-nowrap"}]; 
			...
			case "tbl_design_project":{
				if(val1 == 'approved'){
					...
					let TableData1 = [{data:'id',visible:false},{data:'project_no'},{data:'title',className: "text-nowrap"},{data:'date_created',className: "text-nowrap"},{data:'action'}]; 
					...
					TableData = [{data:'id',visible:false},{data:'project_no'},{data:'title',className: "text-nowrap"},{data:'date_created',className: "text-nowrap"},{data:'action'}]; 
					...
					let TableData2 = [{data:'id',visible:false},{data:'project_no'},{data:'title',className: "text-nowrap"},{data:'date_created',className: "text-nowrap"},{data:'action'}]; 
			...
			case "tbl_customized":{
				...
				TableData = [{data:'no',visible:false},{data:'subject'},{data:'requestor',className: "text-nowrap"},{data:'date_created'},{data:'action',orderable:false}]; 
				...
				let TableData1 = [{data:'no',visible:false},{data:'subject'},{data:'requestor',className: "text-nowrap"},{data:'date_created'},{data:'action',orderable:false}]; 
				...
				let TableData2 = [{data:'no',visible:false},{data:'subject'},{data:'requestor',className: "text-nowrap"},{data:'date_created'},{data:'action',orderable:false}]; 
			...
			case "tbl_preoder":{
				...
				TableData = [{data:'order_no'},{data:'title'},{data:'qty'},{data:'requestor',className: "text-nowrap"},{data:'date_created'},{data:'action',orderable:false}]; 
				...
				let TableData1 = [{data:'order_no'},{data:'title'},{data:'qty'},{data:'requestor',className: "text-nowrap"},{data:'date_created'}]; 
				...
				let TableData2 = [{data:'order_no'},{data:'title'},{data:'qty'},{data:'requestor',className: "text-nowrap"},{data:'date_created'}]; 
