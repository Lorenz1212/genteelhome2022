	...
	var _initWizard = function () {
		...
		_wizardObj.on('submit', function (wizard) {
			...
			if (!rowCount) {
			    ...
			    val = {project_no:project_no,unit:unit,mat_type,mat_itemno,mat_item:mat_name,mat_quantity:mat_quantity,mat_unit:mat_unit,mat_remarks:mat_remarks,pur_item:p_itemno,pur_quantity:p_quantity,pur_unit:p_unit,pur_remarks:p_remarks,pur_type:p_type};
			    thisURL = baseURL + 'create_controller/Create_Joborder_Project';
			    let role = $('input[name=role]').val();
			    if(role == 'production'){
			    	 url = baseURL + 'gh/production/joborder-project-create';
			    }else if(role == 'superuser'){
			    	 url = baseURL + 'gh/superuser/joborder-project-create';
			    }else if(role == 'admin'){
			    	 url = baseURL + 'gh/admin/joborder-project-create';
			    }else if(role == 'designer'){
			    	 url = baseURL + 'gh/designer/joborder-project-create';
			    }
