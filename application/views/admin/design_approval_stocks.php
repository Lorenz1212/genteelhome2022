<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="design-stocks-approval">
			    ...
			    <div class="card-body">
			        <div class="tab-content">
			            <div class="tab-pane fade show active" id="request" role="tabpanel" aria-labelledby="request">
			                <table class="table table-bordered table-hover table-checkable" id="tbl_approval_design_stocks_request">
								<thead>
									<tr>
										<th>NO</th>
										<th>IMAGE</th>
			            ...
			            <div class="tab-pane fade" id="approved" role="tabpanel" aria-labelledby="approved">
			                <table class="table table-bordered table-hover table-checkable" id="tbl_approval_design_stocks_approved">
								<thead>
									<tr>
										<th>NO</th>
										<th>IMAGE</th>
			            ...
			            <div class="tab-pane fade" id="rejected" role="tabpanel" aria-labelledby="rejected">
			                <table class="table table-bordered table-hover table-checkable" id="tbl_approval_design_stocks_rejected">
								<thead>
									<tr>
										<th>NO</th>
										<th>IMAGE</th>
