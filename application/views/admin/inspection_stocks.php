<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="inspection-stocks">
  <div class="form" data-link="Update_Approval_Inspection_Stocks"></div>
	<div class="subheader py-2 py-lg-12 subheader-transparent" id="kt_subheader">
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Inspection Request For Stocks Approval</h2>
				</div>
			</div>
		</div>
	</div>
			            ...
			            <ul class="nav nav-tabs nav-bold nav-tabs-line">
			                <li class="nav-item">
			                    <a class="nav-link active" data-toggle="tab" href="#request">
			                        ...
			                        <span class="nav-text">Request <span class="label label-rounded label-warning stocks_inpection_pending">0</span></span>
			                    </a>
			                </li>
			                <li class="nav-item">
			                    <a class="nav-link" data-toggle="tab" href="#approved">
			                        <span class="nav-icon"><i class="flaticon-list-3"></i></span>
			                        <span class="nav-text">Approved <span class="label label-rounded label-success stocks_inpection_approved">0</span></span>
			                    </a>
			                </li>
			                <li class="nav-item">
			                    <a class="nav-link" data-toggle="tab" href="#rejected">
			                        <span class="nav-icon"><i class="flaticon2-cross"></i></span>
			                        <span class="nav-text">Rejected <span class="label label-rounded label-danger stocks_inpection_rejected">0</span></span>
			                    </a>
			                </li>
			            </ul>
			        </div>
			    ...
			    <div class="card-body">
			        <div class="tab-content">
			            <div class="tab-pane fade show active" id="request" role="tabpanel" aria-labelledby="request">
			                <table class="table table-bordered table-hover" id="tbl_approval_inspection_stocks_request">
								<thead>
									<tr>
										<th>NO</th>
										<th>TITLE</th>
			            ...
			            <div class="tab-pane fade" id="approved" role="tabpanel" aria-labelledby="approved">
			                 <table class="table table-bordered table-hover" id="tbl_approval_inspection_stocks_approved">
								<thead>
									<tr>
										<th>NO</th>
										<th>TITLE</th>
			            ...
			            <div class="tab-pane fade" id="rejected" role="tabpanel" aria-labelledby="rejected">
			                <table class="table table-bordered table-hover" id="tbl_approval_inspection_stocks_rejected">
								<thead>
									<tr>
										<th>NO</th>
										<th>TITLE</th>
