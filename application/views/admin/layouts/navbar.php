									...
									<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
										...
										<ul class="menu-nav">
											<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
												<a href="<?php echo base_url()."gh/admin/index";?>" class="menu-link">
											...
											<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
												...
												<div class="menu-submenu menu-submenu-classic menu-submenu-left">
													<ul class="menu-subnav">
														...
														<!-- <li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
															<a  href="<?php echo base_url()."gh/admin/purchase-request";?>" class="menu-link">
																<span class="menu-text">Purchase Request</span>
															</a>
														</li> -->
														<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
															<a href="javascript:;" class="menu-link">
																<span class="menu-text">Inspection Request</span>
																<i class="menu-arrow"></i>
															</a>
													...
													<!-- <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
															...
															<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																<ul class="menu-subnav">
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/admin/user-request?".base64_encode('urlstatus=request')."";?>"  class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/admin/user-request?".base64_encode('urlstatus=rejected')."";?>"  class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
								...
								<div class="dropdown">
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto" id="kt_quick_user_toggle">
											...
											<span class="text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4"><?php echo $this->appinfo->admin('_ADMIN_FNAME') ?></span>
											<span class="symbol symbol-35">
												<?php 
												 echo($this->appinfo->admin('_ADMIN_PROFILE')=="default.png") ? '<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30 text-uppercase">'.$this->appinfo->admin('_ADMIN_FNAME')[0].'</span>' : '<div class="symbol-label" style="background-image:url('.base_url().'images/profile/'.$this->appinfo->admin('_ADMIN_PROFILE').')"></div>';
												?>
											</span>
										</div>
									</div>
