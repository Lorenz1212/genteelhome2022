									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto" id="kt_quick_user_toggle">
											...
											<span class="symbol symbol-35">
												<?php 
												 echo($this->appinfo->admin('_ADMIN_PROFILE')=="default.png") ? '<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30 text-uppercase">'.$this->appinfo->admin('_ADMIN_FNAME')[0].'</span>' : '<div class="symbol-label" style="background-image:url(images/profile/'.$this->appinfo->admin('_ADMIN_PROFILE').')"></div>';
												?>
											</span>
										</div>
									</div>
