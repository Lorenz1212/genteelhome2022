			    ...
			    <div class="card-body">
			        <div class="tab-content">
			            <div class="tab-pane fade show active" id="request" role="tabpanel" aria-labelledby="request">
			               <table class="table table-bordered table-hover table-checkable link" id="tbl_approval_salesorder_request" data-link="tbl_approval_salesorder" style="margin-top: 13px !important">
								<thead>
									<tr>
										<th>SO NO.</th>
										<th>SALES PERSON</th>
			            ...
			            <div class="tab-pane fade" id="approved" role="tabpanel" aria-labelledby="approved">
			                <table class="table table-bordered table-hover table-checkable" id="tbl_approval_salesorder_approved" style="margin-top: 13px !important">
								<thead>
									<tr>
										<th>SO NO.</th>
										<th>SALES PERSON</th>
			            ...
			            <div class="tab-pane fade" id="rejected" role="tabpanel" aria-labelledby="rejected">
			               <table class="table table-bordered table-hover table-checkable" id="tbl_approval_salesorder_rejected" style="margin-top: 13px !important">
								<thead>
									<tr>
										<th>SO NO.</th>
										<th>SALES PERSON</th>
