<div id="myModal" class="modal-image">
  ...
  <div id="caption"></div>
	...
	<!--begin::Footer-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<?php 
							echo ($this->appinfo->accounting('_ACCOUNTING_PROFILE')=="default.png") ? '<span class="symbol-label font-size-h5 font-weight-bold text-uppercase">'.$this->appinfo->accounting('_ACCOUNTING_FNAME')[0].'</span>' : '<div class="symbol-label" style="background-image:url('.base_url().'assets/images/profile/'.$this->appinfo->accounting('_ACCOUNTING_PROFILE').')"></div>';
							?>
				...
				<div class="navi navi-spacer-x-0 p-0">
					<!--begin::Item-->
					<a href="<?php echo base_url()?>gh/accounting/user_update" class="navi-item">
						<div class="navi-link">
					...
					<!--end:Item-->
					<a href="<?php echo base_url()?>gh/accounting/tutorial" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
		...
		<?php $this->load->view('accounting/layouts/script.php')?>
		</body>
	<!--end::Body-->
</html>