											...
											<div class="card-body">
												...
												<div class="tab-content">
													<div class="tab-pane active" id="stocks" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_spareparts">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
													...
													<div class="tab-pane" id="out-stocks" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_spareparts_outofstocks">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
													...
													<div class="tab-pane" id="new-stocks" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_spareparts_new">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
													...
													<div class="tab-pane" id="release-stocks" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_spareparts_release">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
