<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="data-saleorder">
						...
						<!--begin::Tap pane-->
							<div class="tab-pane fade show active" id="day" role="tabpanel" aria-labelledby="day">
								...
								<div class="table-responsive">
									<table class="table  table-vertical-center"  id="tbl_salesorder_daily">
										<thead>
											<tr>
												<th>DATE</th>
												<th>NAME</th>
							...
							<div class="tab-pane fade" id="weekly" role="tabpanel" aria-labelledby="weekly">
								<!--begin::Table-->
								<div class="table-responsive">
									<table class="table table-vertical-center" id="tbl_salesorder_weekly">
										<thead>
											<tr>
							...
							<div class="tab-pane fade" id="monthly" role="tabpanel" aria-labelledby="monthly">
								<!--begin::Table-->
								<div class="table-responsive">
									<table class="table table-vertical-center" id="tbl_salesorder_monthly">
										<thead>
											<tr>
							...
							<div class="tab-pane fade" id="yearly" role="tabpanel" aria-labelledby="yearly">
								<!--begin::Table-->
								<div class="table-responsive">
									<table class="table table-vertical-center" id="tbl_salesorder_yearly">
										<thead>
											<tr>
