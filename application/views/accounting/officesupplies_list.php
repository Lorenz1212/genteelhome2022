											...
											<div class="card-body">
												...
												<div class="tab-content">
													<div class="tab-pane active" id="stocks" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable link" id="tbl_officesupplies" data-link="tbl_officesupplies">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
													...
													<div class="tab-pane" id="out-stocks" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_officesupplies_outofstocks">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
													...
													<div class="tab-pane" id="new-stocks" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_officesupplies_new">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
													...
													<div class="tab-pane" id="release-stocks" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_officesupplies_release">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
