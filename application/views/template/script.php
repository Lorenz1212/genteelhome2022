		...
		<script src="<?php echo base_url(); ?>assets/js/custom/url_controller/url_title.js"  type='text/javascript'></script>
		<script src="<?php echo base_url(); ?>assets/js/custom/datatable_controller/datatable-client-side.js"  type='text/javascript'></script> 
		<!--END URL Controller-->