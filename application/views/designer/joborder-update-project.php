		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Update Job Order For Project</h2>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-xl-3 col-xxl-3 col-md-3">
				<div class="card card-custom gutter-b">
				    <div class="card-header card-header-tabs-line">
			   		...
			   		<div class="card-body">
			   			<form class="form" id="Update_Joborder_Project" data-link="Update_Joborder_Project" accept-charset="utf-8"  enctype="multipart/form-data">
			       		 <div class="row">
