		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Update Job Order For Stocks</h2>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-xl-3 col-xxl-3 col-md-3">
				<div class="card card-custom gutter-b">
				    <div class="card-header card-header-tabs-line">
			   		...
			   		<div class="card-body">
			   			<form class="form" id="Update_Joborder_Stocks" data-link="Update_Joborder_Stocks" accept-charset="utf-8"  enctype="multipart/form-data">
			       		 <div class="row">
							...
							<div class="col-lg-12 col-xl-12 col-md-12">
								 <div class="form-group">
									   <label>PALLETE COLOR</label>
									    <div class="input-group">
									     <input type="text" class="form-control form-control-solid form-control-lg" id="c_name" required >
									     <div class="input-group-append" style="padding-left: 10px;">
					   		...
					   		<div class="card-body">
								       		<div class="row">
												...
												<div class="col-xl-2 col-xxl-2 col-md-2">
													<div class="form-group">
														<label>QTY</label>
														<input type="number" class="form-control form-control-solid form-control-md" id="quantity" name="qty" placeholder="0" min="1" autocomplete="off"/>
													</div>
												</div>
