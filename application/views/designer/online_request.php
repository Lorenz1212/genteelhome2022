		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Online Order Request</h2>
	...
	<div class="container">
		<div class="form" data-link="Update_OnlineOrder"></div>
			<div class="card card-custom">
				...
				<div class="card-body">
					<table class="table table-bordered table-hover table-checkable link" id="tbl_online_request" data-link="tbl_online_request" style="margin-top: 13px !important">
						<thead>
							<tr>
								<th>ORDER NO.</th>
								<th>IMAGE</th>
