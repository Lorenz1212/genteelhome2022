		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Request for Product Stocks</h2>
...
<div class="d-flex flex-column-fluid">
	<div class="container">
			<div class="card card-custom">
				...
				<div class="card-body">
					<table class="table table-bordered table-hover table-checkable link" id="tbl_customization_request" data-link="tbl_customization_request" style="margin-top: 13px !important">
						<thead>
							<tr>
								<th>SO NO.</th>
								<th>SALES PERSON</th>
...
<div class="modal fade" id="requestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    	<div class="form" data-link="Update_Approval_Customization"></div>
    		<input type="hidden" id="page" value="request-for-stocks">
