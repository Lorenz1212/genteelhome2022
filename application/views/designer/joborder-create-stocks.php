...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="data-jobeorder-create-stocks">
			...
			<div class="col-xl-3 col-xxl-3 col-md-3">
				<div class="card card-custom gutter-b">
				    <div class="card-header card-header-tabs-line">
			   		...
			   		<div class="card-body">
			   			<form class="form" id="Create_Joborder_Stocks" data-link="Create_Joborder_Stocks" accept-charset="utf-8"  enctype="multipart/form-data">
			       		 <div class="row">
								   ...
								   <div class="input-group">
									   <select class="form-control form-control-solid form-control-lg selectpicker" data-live-search="true" id="project_no" name="project_no" required />
									     <option value="" disabled="" selected="">Select Item</option>
										    <?php 
													  $query = $this->db->select('*')->from('tbl_project_design')->where('type',1)->where('project_status','APPROVED')->order_by('id','DESC')->get();
