<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="joborder-project">
			                ...
			                <li class="nav-item">
			                 ...
			                 <li class="nav-item">
			                    <a class="nav-link" data-toggle="tab" href="#request">
			                        <span class="nav-text">Request <span class="label label-rounded label-primary request_jo_project">0</span></span>
			                    </a>
			                </li>
			            </ul>
			        </div>
