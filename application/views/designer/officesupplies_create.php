<!--begin::Content-->
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="data-officesupplies-create">
	...
	<div class="container">
		<div class="row">
			<div class="col-xl-3">
				...
				<!--begin:: Form-->
						<form class="form" data-link="Create_OfficeSupplies_Request">
							<input type="hidden" name="page" value="designer">
						<div class="card-body">
							 <div class="form-group">
								   <label>ITEM:</label>
								   <select class="form-control" id="officesupplies" name="item"/></select>
							...
							<div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
								<div class="col-md-9">
									<div class="d-flex justify-content-between">
										<button type="button" class="btn btn-light-primary font-weight-bold" id="Create_OfficeSupplies_Request">Submit</button>
									</div>
								</div>
							</div>
						</div>
