<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="data-approval-salesorder">
			            ...
			            <ul class="nav nav-tabs nav-bold nav-tabs-line">
			                <li class="nav-item">
			                    <a class="nav-link active" data-toggle="tab" href="#request">
			                        ...
			                        <span class="nav-text">TRANSIT</span>
			                    </a>
			                </li>
			                <li class="nav-item">
			    ...
			    <div class="card-body">
			        <div class="tab-content">
			            <div class="tab-pane fade show active" id="request" role="tabpanel" aria-labelledby="request">
			               <table class="table table-bordered table-hover table-checkable link" id="tbl_salesorder_shipping" data-link="tbl_salesorder_shipping" style="margin-top: 13px !important">
								<thead>
									<tr>
										<th>SO NO.</th>
										<th>SALES PERSON</th>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
                    <div class="modal-body">
                    	<div class="form" data-link="Update_Release_SalesOrder"></div>
					 ...
					 <div class="modal-footer" id="delivered_btn">
					 	<div class="row">
						 		<div class="col-md-8">
						 			<input type="text" class="form-control" placeholder="Sales Invoice" name="si_no">
						 		</div>
						 		<div class="col-md-4">
						 			<button type="button" class="btn btn-success font-weight-bold " id="Update_Release_SalesOrder">SUBMIT</button>
						 		</div>
					 		</div>
            	    </div>
				</div>
