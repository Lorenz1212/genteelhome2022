<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="data-reviewer-user-create">
					...
					<div class="card card-custom">
						<div class="card-header">
							...
							<form class="form" id="Create_Users" data-link="Create_Users" enctype="multipart/form-data" accept-charset="utf-8">
								...
								<input type="hidden"  name="page" value="superuser" />
								<div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="form-group row"> 
													...
													<div class="col-lg-6">
														   ...
														   <input class="form-control form-control-solid form-control-lg" name="conpassword" type="password"  />
													</div>
											</div>
											<div class="form-group row">
												<div class="col-lg-12">
