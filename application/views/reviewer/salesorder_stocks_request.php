			            ...
			            <ul class="nav nav-tabs nav-bold nav-tabs-line">
			                <li class="nav-item">
			                    <a class="nav-link active" data-toggle="tab" href="#shipping">
			                        ...
			                        <span class="label label-rounded label-warning sales_stocks">0</span>
			                    </a>
			                </li>
			                <li class="nav-item">
			                    <a class="nav-link" data-toggle="tab" href="#delivered">
			                        <span class="nav-text mr-2">FOR DELIVERY</span>
			                        <span class="label label-rounded label-success sales_deliver_stocks">0</span>
			                    </a>
			                </li>
			            </ul>
			   		 </div>
