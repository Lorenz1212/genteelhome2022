	...
	<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Office Supplies and Janitorialss</h2>
				</div>
			</div>
		</div>
	</div>
											...
											<div class="card-body">
												...
												<ul class="dashboard-tabs nav nav-pills nav-dark row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
													...
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
														<a class="nav-link active border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#request">
															...
															<span class="nav-text font-size-lg py-2 font-weight-bold text-center">STOCKS</span>
														</a>
													</li>
													<!--end::Item-->
													<!--begin::Item-->
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
														<a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#inprogress">
															...
															<span class="nav-text font-size-lg py-2 font-weight-bolder text-center">OUT OF STOCKS</span>
														</a>
													</li>
													<!--end::Item-->
													<!--begin::Item-->
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
														<a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#partial">
															...
															<span class="nav-text font-size-lg py-2 font-weight-bolder text-center">NEW STOCKS</span>
														</a>
													</li>
													<!--end::Item-->
												</ul>
												...
												<div class="tab-content m-0 p-10">
													...
													<div class="tab-pane" id="inprogress" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_officesupplies_outofstocks" style="margin-top: 13px !important">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
													...
													<div class="tab-pane" id="partial" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_officesupplies_new"  style="margin-top: 13px !important">
															<thead>
																<tr>
																	<th>No.</th>
																	<th>ITEM</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
			   ...
			   <div class="form-group">
			    ...
			    <input type="number" min="0" class="form-control" name="stocks" id="release"/>
			   </div>
			   <div class="form-group">
			    <label>Stocks Alert <span class="text-danger">*</span></label>
			    <input type="number" min="0" class="form-control" name="stocks_alert" id="alert"/>
			   </div>
			    <div class="form-group">
