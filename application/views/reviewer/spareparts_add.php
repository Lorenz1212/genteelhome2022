<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="data-spareparts">
	<div class="subheader py-2 py-lg-12 subheader-transparent" id="kt_subheader">
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Create Spare Parts</h2>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
							...
							<div class="d-flex">
								<div class="flex-grow-1">
									...
									<div class="d-flex justify-content-center px-8 my-lg-5 px-lg-5">
										...
										<form class="form" id="Create_SpareParts" data-link="Create_SpareParts">
											<div class="row">
											  <div class="col-lg-6">
											...
											<div class="d-flex justify-content-between border-top mt-5 pt-3">
												<div>
													<button type="click" id="Create_SpareParts_btn" class="btn btn-sm btn-success font-weight-bolder text-uppercase px-9 py-4 type">Save</button>
												</div>
											</div>
										</form>
									  </div>
		...
		<div class="card card-custom gutter-b">
			<div class="card-header">
				...
				<div class="card-body">
					<!--begin: Datatable-->
						<table class="table table-bordered table-hover table-checkable link" id="tbl_spareparts_add" data-link="tbl_spareparts_add" style="margin-top: 13px !important">
							<thead>
								<tr>
									<th>NO</th>
									<th>ITEM</th>
...
<div class="modal fade" id="exampleModal" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form" id="Update_SpareParts" data-link="Update_SpareParts">
