<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="data-officesupplies-request-list">
	<div class="subheader py-2 py-lg-12 subheader-transparent" id="kt_subheader">
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Office & Janitorial Supplies Request</h2>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="card card-custom gutter-b">
								...
								<div class="card-body">
									...
									<ul class="dashboard-tabs nav nav-pills nav-dark row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
										...
										<!--begin::Item-->
										<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
											<a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#partial">
												<span class="nav-icon py-2 w-auto">
													<span class="svg-icon svg-icon-3x">
												...
												<span class="nav-text font-size-lg py-2 font-weight-bolder text-center">PARTIAL</span>
											</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
											<a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#warehouse">
												<span class="nav-icon py-2 w-auto">
												...
												<span class="nav-text font-size-lg py-2 font-weight-bolder text-center">WAREHOUSE</span>
											</a>
										</li>
										<!--end::Item-->
									</ul>
									...
									<div class="tab-content m-0 p-10">
										<div class="tab-pane active" id="request" role="tabpanel">
											<table class="table table-bordered table-hover table-checkable link" id="tbl_approval_officesupplies_request" data-link="tbl_approval_officesupplies" style="margin-top: 13px !important">
												<thead>
													<tr>
														<th>REQUEST NO.</th>
														<th>REQUESTOR</th>
										...
										<div class="tab-pane" id="partial" role="tabpanel">
											<table class="table table-bordered table-hover table-checkable" id="tbl_approval_officesupplies_partial"  style="margin-top: 13px !important">
												<thead>
													<tr>
														<th>REQUEST NO.</th>
														<th>REQUESTOR</th>
										...
										<div class="tab-pane" id="warehouse" role="tabpanel">
											<table class="table table-bordered table-hover table-checkable" id="tbl_approval_officesupplies_complete" style="margin-top: 13px !important">
												<thead>
													<tr>
														<th>No</th>
														<th>REQUEST NO</th>
...
<div class="modal fade" id="requestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
        	<form class="form" data-link="Update_Officesupplies_Request_Approval">
						...
						<div class="row justify-content-center">
							<div class="col-md-9">
									<div class="table-responsive">
										<table class="table" id="tbl_officesupplies_request_modal">
											<thead>
