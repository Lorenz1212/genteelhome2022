<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="data-material-request-project">
	<div class="form" data-link="Update_Material_Request_Project_Process"></div>
	<div class="subheader py-2 py-lg-12 subheader-transparent" id="kt_subheader">
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Material Request For Project</h2>
				</div>
			</div>
		</div>
	</div>
										           ...
										           <ul class="nav nav-tabs nav-bold nav-tabs-line">
													...
													<li class="nav-item">
														 <a class="nav-link active" data-toggle="tab" href="#request">
									                        ...
									                        <span class="label label-rounded label-warning material_request_pending_project">0</span>
									                    </a>
													</li>
													<!--end::Item-->
													<!--begin::Item-->
