			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<?php 
							 echo($this->appinfo->production('_PRODUCTION_PROFILE')=="default.png") ? '<span class="symbol-label font-size-h5 font-weight-bold  text-uppercase">'.$this->appinfo->production('_PRODUCTION_FNAME')[0].'</span>' : '<div class="symbol-label" style="background-image:url('.base_url().'assets/images/profile/'.$this->appinfo->production('_PRODUCTION_PROFILE').')"></div>';
							?>
