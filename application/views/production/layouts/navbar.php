									...
									<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
										<ul class="menu-nav">
											<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
												<a href="<?php echo base_url()."gh/production/index";?>" class="menu-link">
												...
												<div class="menu-submenu menu-submenu-classic menu-submenu-left">
													<ul class="menu-subnav">
														<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
																...
																<ul class="menu-subnav">
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/production/salesorder-create-stocks";?>" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																			<span class="menu-text">For Stock</span>
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/production/salesorder-create-project";?>" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																			<span class="menu-text">For Project</span>
												...
												<div class="menu-submenu menu-submenu-classic menu-submenu-left">
													...
													<!-- <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
															...
															<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																<ul class="menu-subnav">
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/production/finishproduct?".base64_encode('urlstatus=stocks')."";?>" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
