<!--begin::Content-->
<div class="content d-flex flex-column flex-column-fluid" id="kt_content" data-table="data-joborder-stocks-list">
...
<div class="modal fade" id="requestAddModal" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
		    ...
		    <div class="modal-footer"><button class="btn btn-dark btn-shadow" id="create_joborder_request">Submit <i class="flaticon2-paper-plane"></i></button></div>
		</div>
	</div>
</div>