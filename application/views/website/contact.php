<div id="kt_content" data-table="data-registration"></div>
	<!-- ========================  Main header ======================== -->
                                               ...
                                               <form class="form" data-link="Create_Email" enctype="multipart/form-data" accept-charset="utf-8">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 text-center">
                                                            <input type="button" id="Create_Email" class="btn btn-clean" value="Send message">
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
