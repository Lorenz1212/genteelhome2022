<!-- ========================  Main header ======================== -->
        ...
        <section class="cards">
            ...
            <div class="container">
             ...
             <!--        <div class="col-md-12">
                        <figure>
                            <figcaption style="background-image:url(<?php echo base_url() ?>assets_website/images/blog-7.jpg)">
                                <img src="assets/images/blog-3.jpg" alt="" />
                            </figcaption>
                            <a href="<?php echo base_url()."gh/app/interior-list/".base64_encode('EXPERIENCES')."";?>" class="btn btn-clean">Experiences</a>
                        </figure>
                    </div>
 -->
                </div> <!--/row-->
