		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex flex-column">
					<h2 class="text-white font-weight-bold my-2 mr-5">Collection</h2>
				</div>
			</div>
		</div>
	</div>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-body">
												...
												<ul class="dashboard-tabs nav nav-pills nav-danger row row-paddingless m-0 p-0 flex-column flex-sm-row" role="tablist">
													...
													<!--begin::Item-->
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
														<a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#collected">
															<span class="nav-icon py-2 w-auto">
																<span class="svg-icon svg-icon-3x">
															...
															<span class="nav-text font-size-lg py-2 font-weight-bolder text-center">COLLECTED</span>
														</a>
													</li>
													<!--end::Item-->
													<!--begin::Item-->
													<li class="nav-item d-flex col-sm flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
														<a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center" data-toggle="pill" href="#create">
															<span class="nav-icon py-2 w-auto">
															...
															<span class="nav-text font-size-lg py-2 font-weight-bolder text-center">CREATE</span>
														</a>
													</li>
													<!--end::Item-->
												</ul>
												...
												<div class="tab-content m-0 p-10">
													<div class="tab-pane active" id="request" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable link" id="tbl_customer_deposite" data-link="tbl_customer_deposite" style="margin-top: 13px !important">
															<thead>
																<tr>
																	<th>TRACKING NO</th>
																	<th>CUSTOMER</th>
													...
													<div class="tab-pane" id="collected" role="tabpanel">
														<table class="table table-bordered table-hover table-checkable" id="tbl_customer_collected" style="margin-top: 13px !important">
															<thead>
																<tr>
																	<th>TRACKING NO</th>
																	<th>CUSTOMER</th>
															 ...
															 <div class="card-body">
															  <div class="form-group row">
															   <div class="col-lg-6">
															    ...
															    <input type="text" name="firstname" class="form-control"  placeholder="Enter Firstname" required="" autocomplete="off" />
															   </div>
															   <div class="col-lg-6">
															    <label>Lastname:</label>
															    <input type="text"  name="lastname" class="form-control" placeholder="Enter Lastname" required="" autocomplete="off"/>
															   </div>
															  </div>
															  <div class="form-group row">
															   <div class="col-lg-6">
															   ...
															   <div class="col-lg-12">
															    <label>Tracking No:</label>
															     <input type="text"  name="order_no" class="form-control" placeholder="Enter your Tracking Number" required="" autocomplete="off"/>
															   </div>
															  </div>
															  <div class="form-group row">
															   <div class="col-lg-6">
															    <label>Deposite Date:</label>
															     <input type="text" name="date_deposite" id="kt_datepicker_4_3" class="form-control" placeholder="MM/DD/YYYY" autocomplete="off"/>
															   </div>
															   <div class="col-lg-6">
															    <label>Amount Deposite:</label>
															     <input type="text" name="amount" id="amount" class="form-control" placeholder="Enter your Mobile No" required="" autocomplete="off"/>
															   </div>
															  </div>
															  <div class="form-group row">
															   <div class="col-lg-6">
