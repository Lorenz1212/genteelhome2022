			            ...
			            <ul class="nav nav-tabs nav-bold nav-tabs-line">
			                ...
			                <li class="nav-item">
			                    <a class="nav-link" data-toggle="tab" href="#shipping">
			                        <span class="nav-text">FOR SHIPPING <span class="label label-rounded label-warning sales_shipping_stocks">0</span></span>
			                    </a>
			                </li>
			                <li class="nav-item">
			                    <a class="nav-link" data-toggle="tab" href="#delivered">
			                        <span class="nav-text">DELIVERED <span class="label label-rounded label-success sales_deliver_stocks">0</span></span>
			                    </a>
			                </li>
			            </ul>
			   		 </div>
