						...
						<div class="card-body d-flex align-items-center justify-content-between flex-wrap">
							<div class="card card-custom mb-12">
										<div class="card-body rounded p-0 d-flex" style="background-color:#DAF0FD;">
											...
											<img class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-cover" src="<?php echo base_url()?>assets/media/svg/illustrations/working.svg"></img>
										</div>
									</div>
						</div>
						<!--end::Body-->
