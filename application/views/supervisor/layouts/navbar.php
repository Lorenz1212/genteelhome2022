									...
									<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
										<ul class="menu-nav">
											<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
												<a href="<?php echo base_url()."gh/supervisor/index";?>" class="menu-link">
												...
												<div class="menu-submenu menu-submenu-classic menu-submenu-left">
													<ul class="menu-subnav">
														<li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
															<a href="<?php echo base_url()."gh/supervisor/joborder-stocks";?>" class="menu-link">
																<span class="menu-text">For Stocks</span>
															</a>
														</li>
														<li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
															<a href="<?php echo base_url()."gh/supervisor/joborder-project";?>" class="menu-link">
										...
										<!-- 	<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
													...
													<ul class="menu-subnav">
															...
															<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																<ul class="menu-subnav">
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/supervisor/material-received";?>" class="menu-link">
														...
														<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
															...
															<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																<ul class="menu-subnav">
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/supervisor/officesupplies-request?".base64_encode('urlstatus=pending')."";?>" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/supervisor/officesupplies-received?".base64_encode('urlstatus=received')."";?>" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																			<span class="menu-text">RECEIVED</span>
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/supervisor/create-officesupplies-request";?>" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
														...
														<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
															...
															<div class="menu-submenu menu-submenu-classic menu-submenu-right">
																<ul class="menu-subnav">
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/supervisor/spare-request?".base64_encode('urlstatus=pending')."";?>" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																			<span class="menu-text">PENDING</span>
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/supervisor/spare-received?".base64_encode('urlstatus=received')."";?>" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																			<span class="menu-text">RECEIVED</span>
																	...
																	<li class="menu-item" aria-haspopup="true">
																		<a href="<?php echo base_url()."gh/supervisor/create-spare-request";?>" class="menu-link">
																			<i class="menu-bullet menu-bullet-dot">
																				<span></span>
																			</i>
																			<span class="menu-text">CREATE REQUEST</span>
											...
											<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
												<a href="<?php echo base_url()?>gh/supervisor/production-stocks" class="menu-link">
